...
function init(callback){
	...
	$.getJSON("data.json", function(data,index) {
			...
			get_rte_api = function(){
				...
				myHeaders.append("Authorization", 'Basic '+btoa('c933855d-eaf5-4e61-ba31-bc3d898deaa9:82577abf-93f8-45d7-8da1-402de5d6a321'));
			...
			get_atmo_api = function(){
				...
				$.getJSON("http://api.atmo-aura.fr/communes/69123/indices?api_token=0dbdde827c0be4916e5a1b414f5ee9a0",function(data,index){
